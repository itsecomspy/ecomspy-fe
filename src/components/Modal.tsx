...
export const Modal = ({
  ...
  close: () => void;
  modalConfirmationText: string | React.ReactNode;
  ...
  return (
    <ModalWrapper>
      <ClickAwayListener onClickAway={close}>
        ...
        border-[#ffffff17] w-[500px] max-w-[90vw] mx-4 rounded-[16px] pt-8 p-4"
        >
          {loading ? (
            ...
            <>
              <div className="text-[14px] text-center text-[#FFFFFFB8] font-light px-2">
                {modalConfirmationText}
              </div>
