...
export const SubActive = ({ subscription, setSwitch }: any) => {
  ...
  const renewalDate = Number(subscription?.endDate) * 1000;
  ...
  const { onUnsubscribe, subscriptionSessionLoading } = useStripe();
...
const modalConfirmationText: any = {
  ...
  fr: "Are you sure you want to cancel your subscription?",
};
